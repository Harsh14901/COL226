(*#line 54.10 "lexer.lex"*)functor CalcLexFun(structure Tokens : Calc_TOKENS)(*#line 1.1 "lexer.lex.sml"*)
=
   struct
...
{fin = [], trans = 1},
{fin = [(N 40)], trans = 0},
{fin = [(N 38),(N 40)], trans = 4},
{fin = [(N 38)], trans = 4},
{fin = [(N 38)], trans = 6},
{fin = [(N 38),(N 40)], trans = 7},
{fin = [(N 38)], trans = 8},
{fin = [(N 38)], trans = 9},
{fin = [(N 28),(N 38)], trans = 4},
{fin = [(N 38),(N 40)], trans = 11},
{fin = [(N 38)], trans = 12},
{fin = [(N 38)], trans = 13},
{fin = [(N 38)], trans = 14},
{fin = [(N 34),(N 38)], trans = 4},
{fin = [(N 19),(N 40)], trans = 16},
{fin = [(N 14)], trans = 0},
{fin = [(N 9),(N 40)], trans = 0},
{fin = [(N 11),(N 40)], trans = 0},
{fin = [(N 7),(N 40)], trans = 20},
{fin = [(N 7)], trans = 20},
{fin = [(N 40)], trans = 22},
{fin = [(N 17)], trans = 0},
{fin = [(N 23),(N 40)], trans = 0},
{fin = [(N 21),(N 40)], trans = 0},
{fin = [(N 4),(N 40)], trans = 26},
{fin = [(N 4)], trans = 26},
{fin = [(N 1)], trans = 0}])
end
...
let fun continue() = lex() in
 ...
 in (yybufpos := i; case yyk of 
  ...
  1 => ((*#line 61.17 "lexer.lex"*)refinc linep; lex()(*#line 313.1 "lexer.lex.sml"*)
)
| 11 => ((*#line 67.17 "lexer.lex"*)Tokens.COLON(!linep, yypos-1)(*#line 315.1 "lexer.lex.sml"*)
)
| 14 => ((*#line 68.18 "lexer.lex"*)Tokens.DECLARROW(!linep, yypos-1)(*#line 317.1 "lexer.lex.sml"*)
)
| 17 => ((*#line 69.18 "lexer.lex"*)Tokens.ARROW(!linep, yypos-1)(*#line 319.1 "lexer.lex.sml"*)
)
| 19 => ((*#line 70.17 "lexer.lex"*)Tokens.ASSIGN(!linep, yypos-1)(*#line 321.1 "lexer.lex.sml"*)
)
| 21 => ((*#line 71.17 "lexer.lex"*)Tokens.LPAREN(!linep, yypos-1)(*#line 323.1 "lexer.lex.sml"*)
)
| 23 => ((*#line 72.17 "lexer.lex"*)Tokens.RPAREN(!linep, yypos-1)(*#line 325.1 "lexer.lex.sml"*)
)
| 28 => ((*#line 73.17 "lexer.lex"*)Tokens.CONST(true ,!linep, yypos-1)(*#line 327.1 "lexer.lex.sml"*)
)
| 34 => ((*#line 74.17 "lexer.lex"*)Tokens.CONST(false ,!linep, yypos-1)(*#line 329.1 "lexer.lex.sml"*)
)
| 38 => let val yytext=yymktext() in (*#line 75.25 "lexer.lex"*)findKeywords(yytext,!linep,yypos-1)(*#line 331.1 "lexer.lex.sml"*)
 end
| 4 => ((*#line 62.17 "lexer.lex"*)lex()(*#line 333.1 "lexer.lex.sml"*)
)
| 40 => let val yytext=yymktext() in (*#line 76.17 "lexer.lex"*)error (yytext ,!linep ,yypos-1); lex()(*#line 335.1 "lexer.lex.sml"*)
 end
| 7 => let val yytext=yymktext() in (*#line 63.14 "lexer.lex"*)Tokens.NUM
	     (List.foldl (fn (a,r) => ord(a) - ord(#"0") + 10*r) 0 (explode yytext),
	      !linep, yypos-1)(*#line 339.1 "lexer.lex.sml"*)
 end
| 9 => ((*#line 66.17 "lexer.lex"*)Tokens.TERM(!linep, yypos-1)(*#line 341.1 "lexer.lex.sml"*)
)
